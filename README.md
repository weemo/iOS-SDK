...
For a full implementation details list, please refer to our SDK documentation: [http://docs.weemo.com/sdk/ios/](http://docs.weemo.com/sdk/ios/) or this [project wiki](https://github.com/weemo/iOS-SDK/wiki).
